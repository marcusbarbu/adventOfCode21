...
class Delta:
    ...
    def calculate(self):
        ...
        self.manhattan = sum([abs(i - j) for i, j in zip(self.a, self.b)])
    ...
    def calculate_deltas(self):
        ...
        for c1 in self.coords:
            for c2 in self.coords:
                ...
                self.manhattans.add(d.manhattan)
        ...
        if len(matches) >= 2:
            ...
            for rotation_index, rotate_delta_delta_target in enumerate(delta_target.get_sequence()):
                ...
                if rdtc == delta_known:
                    ...
                    scanner_positions.append(Coord(*rel_delta.rel_diffs))
...
fake_scanner = Scanner()
for pos in scanner_positions:
    fake_scanner.add_coord(pos)
fake_scanner.add_coord(Coord(0,0,0))

fake_scanner.calculate_deltas()
distances = fake_scanner.manhattans
print(distances)
